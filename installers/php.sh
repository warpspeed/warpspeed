...
apt install -y php8.2 php8.2-cli php8.2-curl php8.2-dev php8.2-fpm php8.2-gd php8.2-imagick php8.2-imap php8.2-intl php8.2-mbstring php8.2-memcached php8.2-mysql php8.2-pgsql php8.2-zip
